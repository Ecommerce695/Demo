...
from super_admin.models import CompanyProfile,Category,collection,images,tags,variants,Product,ProductLaptop,ProductMobile
...
class VendorUpdateVariantsAPI(CreateAPIView):
    serializer_class = product_variant
