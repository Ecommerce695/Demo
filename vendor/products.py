...
from super_admin.models import CompanyProfile,Category,collection,images,tags,variants,Product
...
class VendorAddProductsAPI(CreateAPIView):
...
class VendorUpdateProductsAPI(CreateAPIView):
